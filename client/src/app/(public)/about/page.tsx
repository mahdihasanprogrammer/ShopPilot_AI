...
export default function AboutPage() {
  ...
  const features = [
    ...
    "Apple-inspired sleek light mode aesthetics",
  ];
    ...
    <main className="flex-1 bg-[#faf9fc] py-12 md:py-20">
      <div className="max-w-6xl mx-auto px-4 sm:px-6 lg:px-8 space-y-16 md:space-y-24">
        ...
        <section className="text-center max-w-3xl mx-auto space-y-6 animate-premium-fade">
          ...
          <h1 className="text-3xl md:text-5xl font-extrabold tracking-tight text-text-neutral leading-tight">
          ...
          <p className="text-sm md:text-base text-text-neutral/60 leading-relaxed font-medium">
        ...
        <section className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
          <div className="space-y-6">
            <h2 className="text-2xl font-extrabold text-text-neutral tracking-tight">
              The ShopPilot Experience
            </h2>
            <p className="text-xs md:text-sm text-text-neutral/60 leading-relaxed font-medium">
            ...
            <div className="grid grid-cols-1 sm:grid-cols-2 gap-3 pt-2">
              {features.map((feat, index) => (
                <div key={index} className="flex items-center gap-2 text-xs font-bold text-text-neutral/70">
                  <div className="flex h-5 w-5 shrink-0 items-center justify-center rounded-lg bg-emerald-50 border border-emerald-200 text-emerald-600">
          ...
          <div className="relative rounded-3xl border border-black/[0.05] bg-white p-6 shadow-xl shadow-black/[0.03] space-y-6">
            <div className="flex items-center justify-between border-b border-black/[0.04] pb-4">
              <div className="flex items-center gap-2">
                ...
                <div>
                  <h3 className="text-xs font-black text-text-neutral leading-none">ShopPilot AI Assistant</h3>
                  <span className="text-[9px] font-bold text-emerald-500 mt-0.5 block">Streaming Active</span>
                </div>
              </div>
              <span className="text-[10px] font-black uppercase tracking-wider text-accent bg-accent/5 px-2 py-0.5 rounded-full border border-accent/10">
                Agent
              </span>
            </div>
            ...
            <div className="space-y-4">
              <div className="flex items-start gap-2.5">
                ...
                <p className="rounded-2xl rounded-tl-none bg-primary/[0.03] border border-primary/5 px-3 py-2.5 text-xs text-text-neutral/70 leading-relaxed font-medium italic">
            ...
            <div className="pt-2 flex items-center justify-between text-xs font-bold text-primary">
              ...
              <span className="text-text-neutral/40">Injected Automatically</span>
            </div>
          </div>
        </section>
        ...
        <section className="space-y-12">
          <div className="text-center max-w-xl mx-auto space-y-3">
            <h2 className="text-2xl font-extrabold text-text-neutral tracking-tight">Our Core Values</h2>
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
            {values.map((val, index) => {
              ...
              return (
                <div
                  key={index}
                  className="rounded-3xl border border-black/[0.05] bg-white p-6 shadow-sm hover:shadow-md transition-all duration-300 space-y-4"
                >
                  <div className="inline-flex h-10 w-10 items-center justify-center rounded-2xl bg-primary/[0.04] text-primary border border-primary/5">
                    <Icon className="h-5 w-5" />
                  </div>
                  <h3 className="text-sm font-extrabold text-text-neutral">{val.title}</h3>
                  <p className="text-xs text-text-neutral/60 leading-relaxed font-medium">{val.desc}</p>
                </div>
              );
            })}
          </div>
        ...
        <section className="rounded-3xl bg-gradient-to-br from-primary to-primary-dark p-8 md:p-12 text-center text-white space-y-6 shadow-xl shadow-primary/10">
          ...
          <div className="flex flex-wrap items-center justify-center gap-3">
            <Link
              href="/products"
              className="inline-flex items-center gap-2 rounded-xl bg-white px-6 py-3 text-xs font-bold text-primary hover:bg-gray-50 transition-all shadow-sm cursor-pointer"
            >
              Browse Catalog
