...
export default function AIAssistantHighlight() {
  return (
    <section className="px-6 py-16 sm:px-8 lg:px-12 max-w-7xl mx-auto border-t border-bg-secondary/40">
      <div className="relative overflow-hidden rounded-3xl border border-primary/20 bg-gradient-to-br from-primary/5 via-accent/5 to-background p-8 sm:p-12 lg:p-16 flex flex-col lg:flex-row items-center justify-between gap-12">
        ...
        <div className="flex-1 w-full max-w-sm rounded-2xl border border-bg-secondary bg-background p-6 shadow-lg relative z-10">
          <div className="flex items-center justify-between pb-3 border-b border-bg-secondary mb-4">
          ...
          <div className="space-y-4 text-xs">
            <div className="flex justify-start">
              <div className="rounded-2xl rounded-tl-none bg-bg-secondary border border-bg-secondary p-3 text-text-neutral/80 max-w-[85%] leading-relaxed">
                👋 Hello! Try prompting me in Bengali! For example: <span className="font-semibold text-primary">"১০০ ডলারের মধ্যে সেরা হেডফোন কোনটা?"</span>
              </div>
            </div>
            
            <div className="flex justify-end">
              <div className="rounded-2xl rounded-tr-none bg-primary text-white p-3 max-w-[85%] font-medium leading-relaxed">
            ...
            <div className="flex justify-start">
              <div className="rounded-2xl rounded-tl-none bg-bg-secondary border border-bg-secondary p-3 text-text-neutral/80 max-w-[85%] leading-relaxed">
                ১০০ ডলার বাজেটের মধ্যে আমি আপনাকে <span className="font-semibold text-primary">Anker Soundcore Life Q30</span> ($79.99) নেওয়ার পরামর্শ দেবো। এটিতে চমৎকার Active Noise Cancellation (ANC) এবং ৪০ ঘণ্টার ব্যাটারি ব্যাকআপ রয়েছে।
              </div>
            </div>
          </div>
        </div>
