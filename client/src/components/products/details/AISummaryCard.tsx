  ...
  return (
    <div className="relative overflow-hidden rounded-2xl border border-primary/20 bg-gradient-to-br from-primary/5 via-accent/5 to-background p-6 shadow-sm">
      ...
      <div className="space-y-4 relative z-10">
        <div className="flex flex-wrap items-center justify-between gap-2 border-b border-black/[0.04] pb-3">
        ...
        {loading ? (
          ...
          <p className="text-xs text-text-neutral/80 leading-relaxed font-medium animate-fadeIn">
            {summary}
          </p>
        )}

        <div className="flex items-start gap-1.5 text-[10px] text-text-neutral/45 bg-black/[0.02] rounded-xl p-2.5">
